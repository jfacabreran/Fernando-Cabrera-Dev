...
const translations = {
  ...
  en: {
    ...
    'hero.location': 'Lima, Perú',
    'hero.role': 'Web Developer',
    'hero.description1': 'Web Developer with 5+ years of experience specializing in building scalable and optimized technological solutions.',
    'hero.description2': 'Expert in Svelte, React, Angular, Node.js, Technical SEO.',
    ...
    'about.passionDesc':
      'Web Developer with 5+ years of experience, specializing in architecting scalable, modular, and optimized solutions following industry best practices and Agile methodologies (SCRUM).',
    'about.passionDesc2': 'Currently bridging software engineering and entrepreneurship as the Lead of a Software Factory, leveraging technical SEO expertise to drive web visibility and organic growth.',
    'about.education': 'Education',
    'about.degree1': "Web Development",
    'about.university1': 'Area 51 - Training Center (2018 - 2018)',
